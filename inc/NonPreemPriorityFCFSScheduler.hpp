...
class NonPreemPriorityFCFSScheduler: public Scheduler
{
private:
...
public:
    NonPreemPriorityFCFSScheduler() : Scheduler() {}

    NonPreemPriorityFCFSScheduler(uint num_cores, uint time_unit) : Scheduler(num_cores, time_unit) {}
